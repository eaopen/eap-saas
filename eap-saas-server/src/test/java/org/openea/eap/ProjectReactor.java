...
public class ProjectReactor {
    ...
    private static final String TITLE = "EAP管理系统";
    ...
    public static void main(String[] args) {
        ...
        String titleNew = "EAP管理系统";
        String projectBaseDirNew = projectBaseDir.substring(0, projectBaseDir.lastIndexOf("/")) + "/eap-new2.1"; // 一键改名后，“新”项目所在的目录
